...
class OptimizerFactory:
    @staticmethod
    def get(named_modules, named_params):
        decay_params, no_decay_params = OptimizerFactory._get_params_by_type(named_modules, named_params)
    ...
    def _get_params_by_type(named_modules, named_params):
        params_to_decay = OptimizerFactory._get_linear_weight_params(named_modules)
